...
5. As a **UNREGISTERED USER**, I want to be able to choose a **UNIQUE NICKNAME**.
...
5. As a **GUEST**, I want to be able to view the **PROFILE PAGE** of other users.
...
3. As an **ADMIN**, I want to be able to **REMOVE** challenges from the site.
4. As an **ADMIN**, I want to be able to **CREATE** new challenges for the site.

## G) Play Now Section (USER):
1. As a **USER**, I want to be able to **CREATE A LINK** so that I can **PLAY** with other users/guests.
2. As a **USER**, I want to be able to **SEARCH FOR AN OPPONENT** so that I can **PLAY** with other users/guests.
3. As a **USER**, I want to be able to **CHOOSE THE LANGUAGE** so that I can **PLAY WITH THE SELECTED LANGUAGE**.

## H) Play Now Section (GUEST):
1. As a **GUEST**, I want to be able to go to the **LOGIN PAGE** so that I can **LOG IN AND PLAY**.
2. As a **GUEST**, I want to be able to go to the **REGISTRATION PAGE** so that I can **REGISTER AND PLAY**.
3. As a **GUEST**, I want to be able to **CREATE A LINK** so that I can **PLAY** with other users/guests.
4. As a **GUEST**, I want to be able to **SEARCH FOR AN OPPONENT** so that I can **PLAY** with other users/guests.
5. As a **GUEST**, I want to be able to **CHOOSE THE LANGUAGE** so that I can **PLAY WITH THE SELECTED LANGUAGE**.
