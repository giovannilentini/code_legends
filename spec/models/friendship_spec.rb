...
RSpec.describe Friendship, type: :model do
  let(:user1) { RegisteredUser.create!(auth0_id: 'user1', email: 'example1@gmail.com', password: '123456') }
  let(:user2) { RegisteredUser.create!(auth0_id: 'user2', email: 'example2@gmail.com', password: '123456') }
